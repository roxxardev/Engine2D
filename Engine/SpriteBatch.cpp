...
void SpriteBatch::createRenderBatches() {
	...
	for (unsigned int cg = 1; cg < _glyphPointers.size(); cg++) { //cg - current Glyph
...
void SpriteBatch::createVertexArray() {
	...
	glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, sizeof(Vertex), (void*)offsetof(Vertex, uv)); // uv attribute pointer
