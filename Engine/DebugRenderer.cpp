...
void Engine::DebugRenderer::init() {
...
void Engine::DebugRenderer::drawBox(const glm::vec4& destRect, const ColorRGBA8& color, float angle) {
...
void Engine::DebugRenderer::drawCircle(const glm::vec2& center, const ColorRGBA8& color, float radius) {
...
void Engine::DebugRenderer::render(const glm::mat4& projectionMatrix, float lineWidth) {
	m_program.use();
...
void Engine::DebugRenderer::dispose() {
	if (m_vao) {
